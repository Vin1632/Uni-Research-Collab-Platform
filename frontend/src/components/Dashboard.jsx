    ...
    <main className="dashboard-wrapper">
      ...
      <section className="dashboard-top-bar">
        <section className="filter-container">
          <FaFilter className="filter-icon" onClick={() => setShowDropdown(prev => !prev)} />
          <menu className={`filter-dropdown ${showDropdown ? 'show' : ''}`}>
            <li onClick={() => setSelectedCategory("technology")}>Technology</li>
            <li onClick={() => setSelectedCategory("environment")}>Environment</li>
            <li onClick={() => setSelectedCategory("healthcare")}>Healthcare</li>
            <li onClick={() => setSelectedCategory(null)}>Show All</li>
          </menu>
        </section>
        <button className="add-icon" onClick={() => navigate("/add-proposal")}>
          <FaPlusCircle />
        </button>
      </section>
